...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        '''
        try:
            logging.info("Started data transformation pipeline creation")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Separated input features and target variable")
...
if __name__ == "__main__":
    logging.info("Starting Data Transformation script")
